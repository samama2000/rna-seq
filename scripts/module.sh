export PATH=/data/users/lfalquet/SBC07107_22/scripts:/software/bin:/usr/local/bin:$PATH;
export PATH=/data/users/lfalquet/SBC07107_22/scripts/canu-2.2/bin:/data/users/lfalquet/SBC07107_21/scripts/Flye-2.9/bin:$PATH
